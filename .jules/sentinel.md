...
## 2024-05-19 - [HIGH] Fix XSS via HTML Escaping
**Vulnerability:** User inputs like search query (`searchQ`) and project name (`projectName`) were injected directly into the DOM via `innerHTML` without sanitization.
