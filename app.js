      ...
      body: `
        ...
        <div class="form-group">
          ...
          <div style="display:flex; gap:8px;">
            ...
            <button onclick="app.addTeamMemberToModal()" class="btn btn-primary" aria-label="Add team member" style="padding:0 12px;"><span class="material-symbols-outlined">add</span></button>
          </div>
