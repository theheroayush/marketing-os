...
(function(){
  ...
  // Cache for repeated localStorage access
  ...
  const Storage = {
    getSessions: () => {
      // Prevent repeated JSON.parse overhead on large payloads
      if (!_sessionsCache) {
    ...
    getProfiles: () => {
      // Prevent repeated JSON.parse overhead
      if (!_profilesCache) {
