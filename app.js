  ...
  function renderChatView() {
    ...
    el.innerHTML = `
      <div class="skill-header" style="position:sticky;top:60px;background:var(--bg);z-index:10;padding-bottom:10px;border-bottom:1px solid ${accentColor}44;margin-bottom:16px;">
        <button class="back-btn" onclick="app.navigate('history')" aria-label="Go back" title="Go back"><span class="material-symbols-outlined">history</span></button>
      ...
      <div class="chat-input-wrapper">
        <form onsubmit="app.sendChatMessage(event)" style="position:relative;max-width:600px;margin:0 auto;display:flex;gap:8px;align-items:flex-end;">
          ...
          <button type="submit" disabled style="position:absolute;right:8px;bottom:6px;width:32px;height:32px;border-radius:8px;border:none;background:${accentColor};color:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer;opacity:0.5;transition:0.2s;" id="chat-send-btn" aria-label="Send message" title="Send message">
