...
<button onclick="app.openSkill('social-content')" aria-label="Create Post" class="w-full aspect-square bg-surface-container-high rounded-3xl flex items-center justify-center text-primary group-active:scale-90 transition-transform quick-action-btn">
...
<div class="flex flex-col items-center gap-2 group">
<button onclick="app.navigate('skills')" aria-label="New Strategy" class="w-full aspect-square bg-surface-container-high rounded-3xl flex items-center justify-center text-secondary group-active:scale-90 transition-transform quick-action-btn">
...
<div class="flex flex-col items-center gap-2 group">
<button onclick="app.navigate('analytics')" aria-label="Performance" class="w-full aspect-square bg-surface-container-high rounded-3xl flex items-center justify-center text-tertiary group-active:scale-90 transition-transform quick-action-btn">
  ...
  function renderChatView() {
    ...
    el.innerHTML = `
      <div class="skill-header" style="position:sticky;top:60px;background:var(--bg);z-index:10;padding-bottom:10px;border-bottom:1px solid ${accentColor}44;margin-bottom:16px;">
        ...
        <div style="display:flex;gap:8px;">
          <button class="icon-btn" aria-label="Export to PDF" onclick="app.exportPDF()" title="Export Customized PDF"><span class="material-symbols-outlined">picture_as_pdf</span></button>
      ...
      <div class="flex-col gap-12">
        ${sessions.length > 0 ? sessions.map(s => `
          <div class="card" style="position:relative">
            ...
            <button aria-label="Delete session" onclick="app.deleteSession('${s.id}')" style="position:absolute;top:10px;right:10px;background:none;border:none;color:var(--red);cursor:pointer;" title="Delete">
