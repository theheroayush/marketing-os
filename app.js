      ...
      body: `
        ...
        <div class="form-group">
          ...
          <div style="display:flex; gap:8px;">
            ...
            <button onclick="app.addTeamMemberToModal()" class="btn btn-primary" style="padding:0 12px;" aria-label="Add team member"><span class="material-symbols-outlined" aria-hidden="true">add</span></button>
          </div>
  ...
  function renderSkillsHub() {
    ...
    el.innerHTML = `
      ...
      <div style="background:var(--card-bg);border:1px solid var(--border);border-radius:12px;padding:10px 14px;display:flex;align-items:center;gap:8px;margin-bottom:16px;">
        ...
        ${searchQ ? `<button onclick="app.clearSearch()" style="background:none;border:none;color:var(--text-muted);cursor:pointer;font-size:18px;" aria-label="Clear search">&times;</button>` : ''}
      </div>
  ...
  function renderChatView() {
    ...
    el.innerHTML = `
      <div class="skill-header" style="position:sticky;top:60px;background:var(--bg);z-index:10;padding-bottom:10px;border-bottom:1px solid ${accentColor}44;margin-bottom:16px;">
        ...
        <div style="display:flex;gap:8px;">
          <button class="icon-btn" onclick="app.exportPDF()" title="Export Customized PDF" aria-label="Export to PDF"><span class="material-symbols-outlined" aria-hidden="true">picture_as_pdf</span></button>
