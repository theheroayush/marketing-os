...
(function(){
  ...
  const Storage = {
    getSessions: () => {
      ...
      return _sessionsCache.map(s => ({ ...s, messages: [...(s.messages || [])] }));
    },
    saveSession: (session) => {
    ...
    saveProfiles: (profiles) => {
      ...
      _profilesCache = profiles.map(p => ({ ...p, team: [...(p.team || [])] }));
    },
