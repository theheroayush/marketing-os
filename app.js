      ...
      body: `
        ...
        <div class="form-group">
          ...
          <div style="display:flex; gap:8px;">
            ...
            <button onclick="app.addTeamMemberToModal()" aria-label="Add team member" class="btn btn-primary" style="padding:0 12px;"><span class="material-symbols-outlined" aria-hidden="true">add</span></button>
          </div>
  ...
  function renderSkillsHub() {
    ...
    el.innerHTML = `
      ...
      <div style="background:var(--card-bg);border:1px solid var(--border);border-radius:12px;padding:10px 14px;display:flex;align-items:center;gap:8px;margin-bottom:16px;">
        <span class="material-symbols-outlined" aria-hidden="true" style="color:var(--text-muted);font-size:18px">search</span>
  ...
  function renderChatView() {
    ...
    el.innerHTML = `
      <div class="skill-header" style="position:sticky;top:60px;background:var(--bg);z-index:10;padding-bottom:10px;border-bottom:1px solid ${accentColor}44;margin-bottom:16px;">
        <button class="back-btn" aria-label="Go back to history" onclick="app.navigate('history')"><span class="material-symbols-outlined" aria-hidden="true">history</span></button>
