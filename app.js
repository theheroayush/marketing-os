      ...
      <div class="flex-col gap-12">
        ${sessions.length > 0 ? sessions.map(s => `
          <div class="card" style="position:relative">
            ...
            <button onclick="app.deleteSession('${s.id}')" aria-label="Delete session" style="position:absolute;top:10px;right:10px;background:none;border:none;color:var(--red);cursor:pointer;" title="Delete session">
